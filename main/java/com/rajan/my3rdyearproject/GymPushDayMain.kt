 ...
 * Push day = Focus on Chest and Triceps
 */
...
class GymPushDayMain : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        exerciseOneYes.setOnClickListener {
            updateExerciseData("BenchPress", true)
        }
        exerciseOneNo.setOnClickListener {
            updateExerciseData("BenchPress", false)
        }
        ...
        exerciseTwoYes.setOnClickListener {
            updateExerciseData("InclineBenchPress", true)
        }
        exerciseTwoNo.setOnClickListener {
            updateExerciseData("InclineBenchPress", false)
        }
        ...
        exerciseThreeYes.setOnClickListener {
            updateExerciseData("DumbbellShoulderPress", true)
        }
        exerciseThreeNo.setOnClickListener {
            updateExerciseData("DumbbellShoulderPress", false)
        }
        ...
        exerciseFourYes.setOnClickListener {
            updateExerciseData("TricepCablePushdown", true)
        }
        exerciseFourNo.setOnClickListener {
            updateExerciseData("TricepCablePushdown", false)
        }
        ...
        exerciseFiveYes.setOnClickListener {
            updateExerciseData("OverheadRopeExtension", true)
        }
        exerciseFiveNo.setOnClickListener {
            updateExerciseData("OverheadRopeExtension", false)
        }
        ...
        exerciseSixYes.setOnClickListener {
            updateExerciseData("LateralRaises", true)
        }
        exerciseSixNo.setOnClickListener {
            updateExerciseData("LateralRaises", false)
        }
     ...
     * I have stored it in by having the exercise name and then the weight, sets and reps.
    ...
    private fun updateLineChart(weight: Double, sets: Int, reps: Int, exerciseName: String) {
        ...
        val lineColor = when (exerciseName) {
            "BenchPress" -> Color.BLUE
            "InclineBenchPress" -> Color.RED
            "DumbbellShoulderPress" -> Color.GREEN
            "TricepCablePushdown" -> Color.MAGENTA
            "OverheadRopeExtension" -> Color.rgb(255, 105, 180) // Pink
            "LateralRaises" -> Color.rgb(165, 42, 42) // Brown
            else -> Color.BLACK
        }
