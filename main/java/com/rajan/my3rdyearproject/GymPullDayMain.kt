...
class GymPullDayMain : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.gym_pull_day_main)
        //setContentView(R.layout.gym_push_day_main)

        db = FirebaseFirestore.getInstance()
        userId = FirebaseAuth.getInstance().currentUser?.uid ?: ""
        lineChart = findViewById(R.id.lineChart)

        val backPullButton = findViewById<Button>(R.id.BackToGymFragPull)
        backPullButton.setOnClickListener { v -> backToGymFragment(v) }

        val understandPullDay = findViewById<Button>(R.id.toUnderstandingPullDay)
        understandPullDay.setOnClickListener { v -> goToUnderstandPullDay(v) }

//        val backPushButton = findViewById<Button>(R.id.BackToGymFragPush)
//        backPushButton.setOnClickListener { v -> backToGymFragment(v) }
//
//        val understandPushDay = findViewById<Button>(R.id.toUnderstandingPushDay)
//        understandPushDay.setOnClickListener { v -> goToUnderstandPushDay(v) }
        ...
        exerciseOneYes.setOnClickListener {
            updateExerciseData("BicepCurls", true)
        }
        exerciseOneNo.setOnClickListener {
            updateExerciseData("BicepCurls", false)
        }
        ...
        exerciseTwoYes.setOnClickListener {
            updateExerciseData("HammerCurls", true)
        }
        exerciseTwoNo.setOnClickListener {
            updateExerciseData("HammerCurls", false)
        }
        ...
        exerciseThreeYes.setOnClickListener {
            updateExerciseData("DumbbellRows", true)
        }
        exerciseThreeNo.setOnClickListener {
            updateExerciseData("DumbbellRows", false)
        }
        ...
        exerciseFourYes.setOnClickListener {
            updateExerciseData("TBarRows", true)
        }
        exerciseFourNo.setOnClickListener {
            updateExerciseData("TBarRows", false)
        }
        ...
        exerciseFiveYes.setOnClickListener {
            updateExerciseData("CableMachineRows", true)
        }
        exerciseFiveNo.setOnClickListener {
            updateExerciseData("CableMachineRows", false)
        }
        ...
        exerciseSixYes.setOnClickListener {
            updateExerciseData("LatPulldown", true)
        }
        exerciseSixNo.setOnClickListener {
            updateExerciseData("LatPulldown", false)
        }
    ...
    private fun updateExerciseData(exerciseName: String, completed: Boolean) {
        db.collection(userId)
            ...
            .addOnSuccessListener { documentSnapshot ->
                 ...
                 * It is then added to the data set created above.
    ...
    private fun updateLineChart(weight: Double, sets: Int, reps: Int, exerciseName: String) {
        ...
        val lineColor = when (exerciseName) {
            "BicepCurls" -> Color.BLUE
            "HammerCurls" -> Color.RED
            "DumbbellRows" -> Color.GREEN
            "TBarRows" -> Color.MAGENTA
            "CableMachineRows" -> Color.rgb(255, 105, 180) // Pink
            "LatPulldown" -> Color.rgb(165, 42, 42) // Brown
            else -> Color.BLACK
        }
    ...
    private fun goToUnderstandPullDay(view: View) {
        val newIntent = Intent(this, HowToPullDay::class.java)
        startActivity(newIntent)
    }
...
//    }
//
//    private fun goToUnderstandPushDay(view: View) {
//        val newIntent = Intent(this, HowToPushDay::class.java)
//        startActivity(newIntent)
//    }
